---
name: msw
description: The work loop for every task with more than one step - contract, claims, do/prove, halt, report, and the rule against invented limits. Load at the start of any non-trivial task and whenever a review, edge case, or your own instinct proposes more work.
---
